...
// pasetoToken is a PASETO token maker
type pasetoToken struct {
	paseto       *paseto.V2
	symmetricKey []byte
}

// NewPasetoMaker creates a new pasetoToken
func NewPasetoTokenSvc(symmetricKey string) (Token, error) {
...
func (maker *pasetoToken) Create(userID int64, duration time.Duration) (string, *Payload, error) {
...
func (maker *pasetoToken) Verify(token string) (*Payload, error) {
	payload := &Payload{}
